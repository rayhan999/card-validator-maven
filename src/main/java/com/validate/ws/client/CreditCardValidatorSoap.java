...
public interface CreditCardValidatorSoap {
    ...
    @RequestWrapper(localName = "GetCardType", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.GetCardType")
    @ResponseWrapper(localName = "GetCardTypeResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.GetCardTypeResponse")
    ...
    @RequestWrapper(localName = "IsCommercialCard", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.IsCommercialCard")
    @ResponseWrapper(localName = "IsCommercialCardResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.IsCommercialCardResponse")
    ...
    @RequestWrapper(localName = "ValidCard", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.ValidCard")
    @ResponseWrapper(localName = "ValidCardResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.ValidCardResponse")
    ...
    @RequestWrapper(localName = "ValidCardLength", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.ValidCardLength")
    @ResponseWrapper(localName = "ValidCardLengthResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.ValidCardLengthResponse")
    ...
    @RequestWrapper(localName = "ValidExpDate", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.ValidExpDate")
    @ResponseWrapper(localName = "ValidExpDateResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.ValidExpDateResponse")
    ...
    @RequestWrapper(localName = "ValidMod10", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.ValidMod10")
    @ResponseWrapper(localName = "ValidMod10Response", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.ValidMod10Response")
     ...
     * @param cardNumber
     * @return
     *     returns com.validate.ws.client.Response
     */
    ...
    @RequestWrapper(localName = "GetNetworkID", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.GetNetworkID")
    @ResponseWrapper(localName = "GetNetworkIDResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.GetNetworkIDResponse")
    ...
    @RequestWrapper(localName = "IsFSACard", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.IsFSACard")
    @ResponseWrapper(localName = "IsFSACardResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.IsFSACardResponse")
    ...
    @RequestWrapper(localName = "IsValidCheckRoutingNumber", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.IsValidCheckRoutingNumber")
    @ResponseWrapper(localName = "IsValidCheckRoutingNumberResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.IsValidCheckRoutingNumberResponse")
     ...
     * @param cardNumber
     * @return
     *     returns com.validate.ws.client.IsDebitCardResponse.IsDebitCardResult
     */
    ...
    @RequestWrapper(localName = "IsDebitCard", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.IsDebitCard")
    @ResponseWrapper(localName = "IsDebitCardResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.validate.ws.client.IsDebitCardResponse")
    public com.validate.ws.client.IsDebitCardResponse.IsDebitCardResult isDebitCard(
        @WebParam(name = "CardNumber", targetNamespace = "http://localhost/SmartPayments/")
        String cardNumber);
